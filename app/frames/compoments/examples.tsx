  ...
  return (
    <div tw="flex h-full w-full flex-col" style={{backgroundColor: '#F0F0F0'}}>
      ...
      <div tw="flex flex-col px-14">
        ...
        <span tw="pt-10 text-5xl" style={{color: colorCode}}>Example A - Glider</span>
        ...
        <span tw="pt-10 text-5xl" style={{color: colorCode}}>Example B - Ship in a Bottle</span>
        <span tw="pl-10 pt-6">Oscillators repeat a pattern over a series of time steps. This oscillator was found by Bill Gosper in 1994.</span>

        <span tw="pt-10 text-5xl" style={{color: colorCode}}>Clear</span>
        <span tw="pl-10 pt-6">Marks all cells as dead</span>

        <span tw="pt-10 text-5xl" style={{color: colorCode}}>Back</span>
